        ...
        <div className="space-y-2 text-sm">
          ...
          <div className="flex justify-between">
            ...
            <span className="font-medium text-gray-900">
              {shippingConfig.useCarrierPackage ? (
                <span className="text-blue-700">
                  Carrier Package: {shippingConfig.carrierPackageName || shippingConfig.carrierPackageCode}
                </span>
              ) : (
                <span>Custom Dimensions (from file)</span>
              )}
            </span>
          </div>
          {shippingConfig.useCarrierPackage && (
            Object.keys(columnMapping).some((field) => ['length', 'width', 'height'].includes(field))
          ) && (
            <div className="bg-amber-50 border border-amber-200 rounded p-2 mt-2">
              <div className="flex items-start gap-2">
                ...
                <p className="text-xs text-amber-800">
                  <strong>Note:</strong> Dimension columns in your file will be ignored. Using carrier package instead.
                </p>
              </div>
            </div>
          )}
