...
/**
 * Create a new Job in PACE
 * @param jobData - Job data to create (job number will be auto-generated by PACE)
 */
export async function createPaceJob(jobData: {
  customer: string
  jobType: number
  description: string
  description2?: string
  ...
  const url = `${config.apiUrl}/CreateObject/createJob`
...
/**
 * Create a new JobPart in PACE
 * @param jobPartData - JobPart data to create
 */
export async function createPaceJobPart(jobPartData: {
  ...
  const url = `${config.apiUrl}/CreateObject/createJobPart`
  ...
  const response = await fetch(url, {
    ...
    body: JSON.stringify(jobPartData),
  })
...
/**
 * Update an existing JobPart in PACE
 * @param jobPartData - JobPart data to update
 */
export async function updatePaceJobPart(jobPartData: {
  job: string
  jobPart: string
  description?: string
  quotedPrice?: number
  ...
  const url = `${config.apiUrl}/UpdateObject/updateJobPart`
...
/**
 * Create a new JobComponent in PACE
 * @param jobComponentData - JobComponent data to create
 */
export async function createPaceJobComponent(jobComponentData: {
  job: string
  jobPart: string
  description: string
  qtyOrdered: number
  ...
  const url = `${config.apiUrl}/CreateObject/createJobComponent`
  ...
  const response = await fetch(url, {
    ...
    body: JSON.stringify(jobComponentData),
  })
