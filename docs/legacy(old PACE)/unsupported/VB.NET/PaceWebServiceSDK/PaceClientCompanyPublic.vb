Imports System.Net
Imports PaceWebServiceSDK.efipaceservices.publiccompany

Public Class PaceClientCompanyPublic
    ...
    Public Shared Function getCreateObjectHttpBinding() As CreateObjectHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/CreateObject"
    ...
    Public Shared Function getReadObjectHttpBinding() As ReadObjectHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/ReadObject"
        Dim credential As New NetworkCredential(SDK.USERNAME, SDK.PASSWORD)
    ...
    Public Shared Function getUpdateObjectHttpBinding() As UpdateObjectHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/UpdateObject"
        Dim credential As New NetworkCredential(SDK.USERNAME, SDK.PASSWORD)
    ...
    Public Shared Function getCloneObjectHttpBinding() As CloneObjectHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/CloneObject"
        Dim credential As New NetworkCredential(SDK.USERNAME, SDK.PASSWORD)
    ...
    Public Shared Function getFindObjectsHttpBinding() As FindObjectsHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/FindObjects"
        Dim credential As New NetworkCredential(SDK.USERNAME, SDK.PASSWORD)
    ...
    Public Shared Function getDeleteObjectHttpBinding() As DeleteObjectHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/DeleteObject"
        Dim credential As New NetworkCredential(SDK.USERNAME, SDK.PASSWORD)
    ...
    Public Shared Function getInvokeActionHttpBinding() As InvokeActionHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/InvokeAction"
        Dim credential As New NetworkCredential(SDK.USERNAME, SDK.PASSWORD)
    ...
    Public Shared Function getInvokeProcessHttpBinding() As InvokeProcessHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/InvokeProcess"
        Dim credential As New NetworkCredential(SDK.USERNAME, SDK.PASSWORD)
    ...
    Public Shared Function getGeoLocateHttpBinding() As GeoLocateHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/GeoLocate"
        Dim credential As New NetworkCredential(SDK.USERNAME, SDK.PASSWORD)
    ...
    Public Shared Function getInvokePaceConnectHttpBinding() As InvokePaceConnectHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/InvokePaceConnect"
        Dim credential As New NetworkCredential(SDK.USERNAME, SDK.PASSWORD)
    ...
    Public Shared Function getAttachmentServiceHttpBinding() As AttachmentServiceHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/AttachmentService"
        Dim credential As New NetworkCredential(SDK.USERNAME, SDK.PASSWORD)
    ...
    Public Shared Function getVersionHttpBinding() As VersionHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/Version"
        Dim credential As New NetworkCredential(SDK.USERNAME, SDK.PASSWORD)
    ...
    Public Shared Function getSystemInspectorHttpBinding() As SystemInspectorHttpBinding
        ...
        Dim baseURL As String = "http://" + SDK.HOST + ":" + SDK.PORT.ToString() + "/rpc/company:public/services/SystemInspector"
        Dim credential As New NetworkCredential(SDK.USERNAME, SDK.PASSWORD)
