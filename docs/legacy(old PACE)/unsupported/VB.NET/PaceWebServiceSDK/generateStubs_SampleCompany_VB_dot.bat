...
:: MAKE SOME CODE
ECHO Generating Stub Code: PaceUtilSampleCompany.vb
Call :SubMakeParms %3
wsdl /username:%1 /password:%2 /parameters:parms.xml  1>>stubsgen.log

ECHO Moving the PaceUtilSampleCompany.vb to the project folder
move /Y PaceUtilSampleCompany.vb ./..
...
echo   ^<out^>PaceUtilSampleCompany.vb^</out^> >> parms.xml
