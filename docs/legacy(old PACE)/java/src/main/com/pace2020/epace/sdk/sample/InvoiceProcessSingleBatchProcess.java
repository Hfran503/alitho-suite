...
public class InvoiceProcessSingleBatchProcess extends SecuredWSDLClient
{
    public static void main( final String[] args ) throws Exception
    {
        new InvoiceProcessSingleBatchProcess().run();
    }
        ...
        try
        {
            ...
            final ProcessResults results =
                getInvokeProcessHttpPort()
                    .invoiceProcessSingleBatch( DatatypeFactory.newInstance().newXMLGregorianCalendar( gc ),
                                                "5322" );

            System.out.println( " Invoice Process Single Batch " + ( results.isSuccessful() ? "success" : "failure" ) );
