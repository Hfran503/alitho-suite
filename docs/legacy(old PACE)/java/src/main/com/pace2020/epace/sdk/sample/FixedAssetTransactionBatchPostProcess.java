...
public class FixedAssetTransactionBatchPostProcess extends SecuredWSDLClient
{
    public static void main( final String[] args ) throws Exception
    {
        new FixedAssetTransactionBatchPostProcess().run();
    }
    ...
    public boolean run() throws RemoteException
    {
        try
        {
            final ProcessResults results =
                getInvokeProcessHttpPort().fixedAssetTransactionBatchPostProcess( " @financed = 'true' " );

            System.out.println( " Fixed Asset Transaction Batch Post Process "
