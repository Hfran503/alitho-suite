...
public class ChangeMeasurementSettingsProcess extends SecuredWSDLClient
{
    public static void main( final String[] args ) throws Exception
    {
        new ChangeMeasurementSettingsProcess().run();
    }
    ...
    public boolean run() throws RemoteException
    {
        try
        {
            final ProcessResults results = getInvokeProcessHttpPort().changeMeasurementSettings( 3, true );

            System.out.println( " Change Measurement Settings " + ( results.isSuccessful() ? "success" : "failure" ) );
