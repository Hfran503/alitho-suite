...
public class ScheduledTaskExecutionProcess extends SecuredWSDLClient
{
    public static void main( final String[] args ) throws Exception
    {
        new ScheduledTaskExecutionProcess().run();
    }
    ...
    public boolean run() throws RemoteException
    {
        try
        {
            final ProcessResults results = getInvokeProcessHttpPort().scheduledTaskExecutionProcess( "6" );
