...
public class LibraryImportProcess extends SecuredWSDLClient
{
    public static void main( final String[] args ) throws Exception
    {
        new LibraryImportProcess().run();
    }
        ...
        try
        {
            final ProcessResults results =
                getInvokeProcessHttpPort()
                    .libraryImportProcess( "libraryServer", "public", "Job", "Administrator", "epace",
                                           true );
