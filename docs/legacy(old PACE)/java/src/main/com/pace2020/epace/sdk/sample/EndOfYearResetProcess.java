...
public class EndOfYearResetProcess extends SecuredWSDLClient
{
    public static void main( final String[] args ) throws Exception
    {
        new EndOfYearResetProcess().run();
    }
        ...
        try
        {
            ...
            final ProcessResults results =
                getInvokeProcessHttpPort()
                    .endOfYearReset( DatatypeFactory.newInstance().newXMLGregorianCalendar( gc ), true );

            System.out.println( " End of year reset " + ( results.isSuccessful() ? "success" : "failure" ) );
