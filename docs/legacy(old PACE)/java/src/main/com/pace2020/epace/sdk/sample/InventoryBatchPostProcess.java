...
public class InventoryBatchPostProcess extends SecuredWSDLClient
{
    public static void main( final String[] args ) throws Exception
    {
        new InventoryBatchPostProcess().run();
    }
    ...
    public boolean run() throws RemoteException
    {
        try
        {
            final ProcessResults results = getInvokeProcessHttpPort().inventoryBatchPost( "@id = 5005" );
