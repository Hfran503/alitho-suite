...
public class PayrollBatchPostProcess extends SecuredWSDLClient
{
    public static void main( final String[] args ) throws Exception
    {
        new PayrollBatchPostProcess().run();
    }
    ...
    public boolean run() throws RemoteException
    {
        try
        {
            final ProcessResults results = getInvokeProcessHttpPort().payrollBatchPost( "@payrollBatchID = 5006" );
