...
public class FixedAssetDepreciationCalculationProcess extends SecuredWSDLClient
{
    public static void main( final String[] args ) throws Exception
    {
        new FixedAssetDepreciationCalculationProcess().run();
    }
    ...
    public boolean run() throws RemoteException
    {
        try
        {
            final ProcessResults results =
                getInvokeProcessHttpPort().fixedAssetDepreciationCalculationProcess( " @financed = 'true' " );

            System.out.println( " Fixed Asset Depreciation Calculation Process "
