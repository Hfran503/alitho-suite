...
namespace Pace_Web_Service_SDK
{
	...
	public class SDK
	{
		public static string HOST = "localhost"; //your Pace hostname or IP
		public static int PORT = 80; //your Pace port
		public static string USERNAME = "Administrator"; //your API username
		public static string PASSWORD = "pace"; //your API user password
                ...
                try
                {
                    switch (choice)
                    {
                        ...
                        case 33:
                            ...
                            break;
                        case 34:
                            CreateEstimateAndConvertFromJob.Run();
                            break;
                         case 35:
                            InvoiceJob.Run();
                            break;
        ...
        public static int readInputFromTheUser(String message)
        {
        ...
        public static String readStringInputFromTheUser(String message)
        {
            // Read it from the console
            Console.WriteLine(message);
            try
        ...
        private static int Prompt()
        {
            ...
            Console.WriteLine("\t21) Ganged Activity Job Cost");
            ...
            Console.WriteLine("\t33) Transaction service sample");
            Console.WriteLine("\t34) Generate Schedule For Job");
            Console.WriteLine("\t35) InvoiceJob");
            Console.WriteLine("\t36) Add Job Shipment");
