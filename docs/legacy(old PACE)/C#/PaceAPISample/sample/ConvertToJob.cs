...
namespace Pace_Web_Service_SDK.sample
{
    class ConvertToJob
    {
        public static void Run()
        {
            ...
            int jobTypeId = 1;
            int quoteId = SDK.readInputFromTheUser("Please enter quote id");
            int estimateId = SDK.readInputFromTheUser("Please enter estimate id");
            ...
            {
                Console.WriteLine("Quote not converted " + e.Message);
            }
            ...
            {
                Console.WriteLine("Estimate not converted: " + e.Message);
            }
