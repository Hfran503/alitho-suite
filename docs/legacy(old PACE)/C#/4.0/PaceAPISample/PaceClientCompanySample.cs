...
using System.Text;
using System.Net;
using efipaceservices.samplecompany;

namespace Pace_Web_Service_SDK
{
    class PaceClientCompanySample
    {
        ...
        public static ReadObjectHttpBinding getReadObjectHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/ReadObject";
        ...
        public static CreateObjectHttpBinding getCreateObjectHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/CreateObject";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static UpdateObjectHttpBinding getUpdateObjectHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/UpdateObject";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static FindObjectsHttpBinding getFindObjectsHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/FindObjects";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static InvokeProcessHttpBinding getInvokeProcessHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/InvokeProcess";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static VersionHttpBinding getVersionHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/Version";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static DeleteObjectHttpBinding getDeleteObjectHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/DeleteObject";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static CloneObjectHttpBinding getCloneObjectHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/CloneObject";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static InvokeActionHttpBinding getInvokeActionHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/InvokeAction";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static GeoLocateHttpBinding getGeoLocateHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/GeoLocate";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static InvokePaceConnectHttpBinding getInvokePaceConnectHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/InvokePaceConnect";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static SystemInspectorHttpBinding getSystemInspectorHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/SystemInspector";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static AttachmentServiceHttpBinding getAttachmentServiceHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:sample/services/AttachmentService";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
