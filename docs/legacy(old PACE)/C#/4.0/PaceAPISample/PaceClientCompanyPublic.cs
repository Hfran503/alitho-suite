...
using System.Text;
using System.Net;
using efipaceservices.publiccompany;

namespace Pace_Web_Service_SDK
{
    class PaceClientCompanyPublic
    {
        ...
        public static ReadObjectHttpBinding getReadObjectHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/ReadObject";
        ...
        public static CreateObjectHttpBinding getCreateObjectHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/CreateObject";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static UpdateObjectHttpBinding getUpdateObjectHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/UpdateObject";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static FindObjectsHttpBinding getFindObjectsHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/FindObjects";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static InvokeProcessHttpBinding getInvokeProcessHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/InvokeProcess";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static VersionHttpBinding getVersionHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/Version";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static DeleteObjectHttpBinding getDeleteObjectHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/DeleteObject";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static CloneObjectHttpBinding getCloneObjectHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/CloneObject";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static InvokeActionHttpBinding getInvokeActionHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/InvokeAction";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static GeoLocateHttpBinding getGeoLocateHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/GeoLocate";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static InvokePaceConnectHttpBinding getInvokePaceConnectHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/InvokePaceConnect";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static SystemInspectorHttpBinding getSystemInspectorHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/SystemInspector";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
        ...
        public static AttachmentServiceHttpBinding getAttachmentServiceHttpBinding()
        {
            ...
            string baseURL = "http://" + SDK.HOST + ":" + SDK.PORT + "/rpc/company:public/services/AttachmentService";
            NetworkCredential credential = new NetworkCredential(SDK.USERNAME, SDK.PASSWORD);
