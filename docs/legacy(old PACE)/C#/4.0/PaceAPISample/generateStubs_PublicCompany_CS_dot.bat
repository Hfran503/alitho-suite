...
:: MAKE SOME CODE
ECHO Generating Stub Code: PaceUtilPublicCompany.cs
Call :SubMakeParms %3
wsdl /username:%1 /password:%2 /parameters:parms.xml  1>>stubsgen.log

ECHO Moving the PaceUtilPublicCompany.cs to the project folder
move /Y PaceUtilPublicCompany.cs ./..
...
echo   ^<out^>PaceUtilPublicCompany.cs^</out^> >> parms.xml
