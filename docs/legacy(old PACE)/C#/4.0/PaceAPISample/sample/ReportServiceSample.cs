...
namespace Pace_Web_Service_SDK.sample
{
    ...
    {
        private static FindObjectsHttpBinding findObjectsHttpBinding = PaceClient.getFindObjectsHttpBinding();
        ...
        {
            ReportServiceHttpBinding reportServiceHttpBinding = PaceClient.getReportServiceHttpBinding();
