...
namespace Pace_Web_Service_SDK.sample
{
    class ChargeBackAccountSample
    {
        public static void Run()
        {
            ...
            {
                String[] keys = findObjectsHttpBinding.find("ChargeBackAccount", "@accountNumber = '" + chargeBankAccountNumber + "'");
        ...
        private static Boolean verifyCustomerExists(String customerId, ReadObjectHttpBinding readObjectHttpBinding)
        {
            try
            {
